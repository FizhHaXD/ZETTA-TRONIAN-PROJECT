...
public class EnemyHealth2 : MonoBehaviour
{
    ...
    [Range(0f, 1f)] public float dropChance = 0.75f; // 20% drop
    ...
    void Die()
    {
        ...
        {
            ScoreManager.Instance.AddScore(300); // Tambah 300 poin misalnya
        }

        // 💡 Tambahan: UPGRADE peluru jika asteroid dihancurkan
        if (PlayerBulletUpgrade.Instance != null)
        {
            PlayerBulletUpgrade.Instance.UpgradeToTripleShot(); // Aktifkan mode peluru 3 arah
        }

        // 💠 Drop power up secara acak
